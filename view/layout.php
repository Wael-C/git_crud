...
<html lang="fr">
    ...
    <body>
        ...
        <!-- Affichage des templates stockés dans la variable $content dans la méthode render() du controller -->
        <?= $content ?>

        </div>

        <footer class="jombotron" style="background-color: #7952B3; min-height: 80px">
